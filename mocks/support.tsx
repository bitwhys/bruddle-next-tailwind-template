export const products = [
  {
    id: '0',
    title: 'Wallet',
    content: 'The best self-hosted wallet',
    icon: '/images/wallet.svg',
  },
  {
    id: '1',
    title: 'Commerce',
    content: 'Accept payments from anyone',
    icon: '/images/cart.svg',
  },
  {
    id: '2',
    title: 'Cloud',
    content: 'Build the future of payments',
    icon: '/images/cloud.svg',
  },
  {
    id: '3',
    title: 'Online Trading',
    content: 'Access our trading terminal',
...
export const productCategories = [
  {
    ...
    icon: '/images/bag.svg',
    links: ['Create an account', 'Verify my account', 'Add a payment method'],
  },
  {
    id: '1',
    title: 'Managing my account',
    icon: '/images/profile.svg',
    links: ['Get back into my account', 'Link a payment method', 'Verify my identity'],
  },
  {
    id: '2',
    title: 'Trading and funding',
    icon: '/images/chart.svg',
    links: ['Buying, selling or converting crypto', 'Sending or receiving cryptocurrency', 'Pricing and fees'],
  },
]
