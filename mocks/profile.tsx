...
export const tasks2 = [
  ...
  },
  {
    ...
    time: '4 hours ago',
    avatar: '/images/avatars/avatar-2.jpg',
    content: 'Uploaded 3 new files to the project',
    files: [
      {
        id: '0',
        icon: 'sketch',
      ...
      },
      {
        id: '2',
        icon: 'sketch',
        title: 'Presentation approval.sketch',
      },
    ],
    comments: 23,
    likes: 36,
...
export const tasks3 = [
  {
    ...
    time: '3 hours ago',
    avatar: '/images/avatars/avatar-4.jpg',
    content: 'Assigned new tasks to the project',
    tasks: [
      {
        id: '0',
        isChecked: false,
...
export const experience = [
  {
    ...
    content: 'Minimum 3 shifts a week Monday - Friday with the ability to work',
  ...
  },
  {
    ...
    company: 'Google Inc.',
    duration: '2001 - 2018',
    content: 'Lines for Life also offers a great benefits package valued at over $9,500',
  ...
  },
  {
    ...
    duration: '1998 - 2018',
    content: 'Healthcare Interest — become an expert on emerging healthcare programs',
...
export const connections = [
  {
    ...
    logo: '/images/eliassen-group.svg',
    avatar: '/images/avatars/avatar-14.jpg',
  },
  {
    id: '1',
    man: 'Thitiwat Shimma',
    position: 'Workplace Culture Assessment',
  ...
  },
  {
    ...
    company: 'Shake Shack',
    logo: '/images/shake-shack.svg',
    avatar: '/images/avatars/avatar-16.jpg',
  },
  {
    id: '3',
    man: 'Njimoluh Ebua',
    position: 'Full Time Patient Care Coordinator',
    company: 'Printpack',
    logo: '/images/printpack.svg',
