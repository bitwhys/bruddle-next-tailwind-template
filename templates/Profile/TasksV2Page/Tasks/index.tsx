...
const Tasks = ({}: TasksProps) => {
  ...
  return (
    <>
      <div className="mb-6 flex items-center justify-between lg:mb-4 md:block">
        <Tabs className="md:ml-0" classButton="md:ml-0 md:flex-1" items={types} value={type} setValue={setType} />
