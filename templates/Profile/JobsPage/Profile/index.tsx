...
const Profile = ({}: ProfileProps) => (
  <>
    <div className="relative mb-2.5 h-[5.25rem] w-[5.25rem] lg:mx-auto">
    ...
    <div className="mb-6 text-sm lg:text-center">UI/UX Designer at Eliassen Group Inc.</div>
    <div className="flex items-center text-sm font-medium">
      <div className="mr-2 w-6">
        <Image className="w-full" src="/images/eliassen-group.png" width={24} height={24} alt="" />
      </div>
      Eliassen Group Inc.
    </div>
    <div className="mt-6 border-t border-dashed border-n-1 pt-6 dark:border-white">
      ...
      <div className="mb-4 text-sm">
        Once your resume is on Indeed, you can choose to make it public or private benefits to options.
      </div>
      <div>
        {list.map((item, index) => (
