  ...
  return (
    <Layout title="Courses">
      ...
      <div className="mb-8 flex justify-between md:block">
        <Tabs
          className="lg:ml-0 md:-mx-5 md:flex-nowrap md:overflow-auto md:scroll-smooth md:scrollbar-none md:before:w-5 md:before:shrink-0 md:after:w-5 md:after:shrink-0"
          classButton="lg:ml-0"
          items={typeTasks}
          value={type}
          setValue={setType}
