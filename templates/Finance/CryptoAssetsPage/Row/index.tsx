  ...
  return (
    <tr className="">
      <td className="td-custom md:!pl-4">
        <Link className="flex items-center transition-colors hover:text-purple-1" href="/finance/crypto-assets-details">
          <div className="mr-3 w-6 rounded-full p-0.25 text-0 dark:bg-white">
      ...
      <td className="td-custom text-right md:hidden">${item.marketCap}</td>
      <td className="td-custom text-right font-bold md:!pl-0">${item.price}</td>
      <td className={`td-custom text-right font-bold md:!pl-0 ${item.change > 0 ? 'text-green-1' : 'text-pink-1'}`}>
