    ...
    <tr className="">
      ...
      <td className="td-custom font-medium">
        <div className="flex items-center">
          <Icon className="relative -top-0.25 mr-1.5 dark:fill-white" name="calendar" />
          {item.date}
        </div>
      </td>
      <td className="td-custom font-medium">
        <div className="flex items-center">
          <Icon className="relative -top-0.25 mr-1.5 dark:fill-white" name="email-1" />
          <div className="2xl:max-w-[9rem] 2xl:truncate">{item.email}</div>
        </div>
      </td>
      <td className="td-custom font-medium">
        <div className="flex items-center">
          <Icon className="relative -top-0.25 mr-1.5 dark:fill-white" name="cart" />
          {item.product}
        </div>
      </td>
