...
const GeneralInformation = ({}: GeneralInformationProps) => {
  ...
  return (
    <div className="card">
      ...
      <div className="p-5">
        <Images items={images} />
        <div className="mb-4 flex space-x-5 md:block md:space-x-0 md:space-y-4">
          <Field
            className="flex-1"
            label="Product title"
            ...
            required
          />
          <Select className="flex-1" label="Category" items={categories} value={category} onChange={setCategory} />
        </div>
        <div className="mb-4 flex space-x-5 md:block md:space-x-0 md:space-y-4">
          <Field
            className="flex-1"
        ...
        <div className="flex justify-between md:mt-8 md:block">
