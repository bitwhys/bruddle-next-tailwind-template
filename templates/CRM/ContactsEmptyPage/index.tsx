...
const ContactsEmptyPage = () => {
  ...
  return (
    <>
      ...
      <Modal title="Create new contact" visible={visible} onClose={() => setVisible(false)}>
        <form action="" onSubmit={() => console.log('Submit')}>
          <div className="relative mx-auto mb-6 flex h-[6.375rem] w-[6.375rem] items-center justify-center bg-purple-3">
            <input className="absolute left-0 top-0 h-full w-full cursor-pointer opacity-0" type="file" />
          ...
          <Field
            ...
            required
          />
          <button className="btn-purple btn-shadow w-full">Add contact</button>
        </form>
      </Modal>
    </>
  )
